...
for dataset in "${DATASETS[@]}"; do
  ...
  CUDA_VISIBLE_DEVICES=$GPU python -m src.eval.eval_main --dataset "$dataset" --model Qwen25_1_5B_Instruct --inferencer "$INFERENCER" --fine_tuned_algorithm DCPO --fine_tuned_dataset Hotpot --checkpoint logs/train/hotpot/dcpo/qwen25_1_5b_instruct/2026-0426-0733
