...
#   --fit_path logs/eval/HotpotRLCR_Train/Qwen25_1_5B_Instruct/Baseline/self_consistency/predictions.jsonl \
...
python -m src.calibration.calibrate_main \
  --fit_path logs/eval/HotpotRLCR_Train/Qwen25_1_5B_Instruct/Baseline/self_consistency/predictions.jsonl \
  --eval_path logs/eval/HotpotRLCR_Eval/Qwen25_1_5B_Instruct/Baseline/self_consistency/predictions.jsonl \
