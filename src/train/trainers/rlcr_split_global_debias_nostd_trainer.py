...
class RLCRSplitGlobalDebiasNoStdTrainer(RLCRSplitGlobalDebiasTrainer):
    trainer_name = "rlcr_split_global_debias_nostd"
    ...
    def _compute_global_ema_confidence_advantages(self, confidence_rewards: torch.Tensor, update_ema: bool):
        ...
        confidence_advantages = confidence_rewards - ema_mean
        return confidence_advantages, ema_mean, batch_mean, batch_std
