...
from src.eval.eval_utils import hash_dataset
from src.eval.eval_args import GlobalArgs, LocalConfig
from src.eval.check_functions import confidence_verifier, llm_confidence_verifier 
...
def main(global_args,local_configs):
    ...
    if global_args.store_name is not None:
